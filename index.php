              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    ...
                    <?php echo (array_key_exists("errors", $_SESSION) && array_key_exists("login", $_SESSION['errors'])) ? 
                      "<p class='invalid-feedback'>{$_SESSION['errors']['login']}</p>" : '' ?>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="Controllers/Auth.php" novalidate method="post">
                    ...
                    <div class="col-12">
                      <a href="pages-register.php">Olvide mi contraseña</a>
                    </div>
                  </form>
                </div>
              </div>
